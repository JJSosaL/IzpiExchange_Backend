...
export const ACCOUNT_WITH_SAME_EMAIL_ALREADY_REGISTERED_RESPONSE =
	(): HttpException =>
		buildHttpException({
			data: {
				code: 'ACCOUNT_WITH_SAME_EMAIL_ALREADY_REGISTERED',
				message:
					'Ya existe una cuenta con este mismo correo electrónico registrado',
			},
...
export const EMAIL_DOMAIN_NOT_ALLOWED_RESPONSE = (): HttpException =>
	buildHttpException({
		data: {
			...
			message:
				'El dominio del correo electrónico específicado no está permitido',
		},
