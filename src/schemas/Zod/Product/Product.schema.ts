...
export const ProductCreateSchema = object(
	{
		description: string(PRODUCT_DESCRIPTION_MUST_BE_STRING)
			.min(PRODUCT_DESCRIPTION_MIN_LENGTH, PRODUCT_DESCRIPTION_MUST_HAVE_MIN_LENGTH(PRODUCT_DESCRIPTION_MIN_LENGTH))
			.max(PRODUCT_DESCRIPTION_MAX_LENGTH, PRODUCT_DESCRIPTION_MUST_HAVE_MAX_LENGTH(PRODUCT_DESCRIPTION_MAX_LENGTH)),
		...
		price: coerce.number(PRODUCT_PRICE_MUST_BE_INTEGER).int(PRODUCT_PRICE_MUST_BE_INTEGER).positive(PRODUCT_PRICE_MUST_BE_POSITIVE),
	},
