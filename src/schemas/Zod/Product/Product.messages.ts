export const PRODUCT_DESCRIPTION_MUST_BE_STRING =
	'La descripción del producto debe ser una cadena de texto' as const;
...
export const PRODUCT_NAME_MUST_BE_STRING =
	'El nombre del producto debe ser una cadena de texto' as const;
...
export const PRODUCT_PRICE_MUST_BE_INTEGER =
