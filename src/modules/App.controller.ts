...
import { type CheckVersionDto, CheckVersionSchema } from '#root/schemas/Zod/App/App.schema.js';
/*
...
export class AppController {
	...
	protected checkVersion(
		@Body(new ZodValidationPipe(CheckVersionSchema)) checkVersionData: CheckVersionDto,
	) {
